...
MODEL_PATH = OUT_DIR / "log_flux_plus1_pipeline.pkl"
META_PATH = OUT_DIR / "log_flux_plus1_metadata.json"
...
def main() -> None:
    ...
    meta = {
        ...
        # You told us the log is base-10 (not ln). For the UI later:
        # flux = (10 ** log_flux_plus1) - 1
        "log_base": 10,
        "inverse_transform": "flux = (10 ** log_flux_plus1) - 1",
    }
