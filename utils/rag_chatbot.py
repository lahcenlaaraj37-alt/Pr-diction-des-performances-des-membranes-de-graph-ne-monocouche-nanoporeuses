...
3. If the user asks for simulation results, provide the calculated values
    ...
    def answer_message(self, message: str) -> str:
        ...
        try:
            ...
            response = self.groq_client.chat.completions.create(
                model="llama3-70b-8192",  # Use Llama 3.1 70B
                messages=[
...
def answer_user_message(message: str, api_key: str = None) -> str:
    """Main interface function - compatible with existing code"""
    chatbot = get_chatbot()
    return chatbot.answer_message(message)
