...
/* إبقاء شريط Streamlit الأصلي في أعلى طبقة لضمان عمل الأزرار 100% */
header[data-testid="stHeader"] {
    z-index: 99999 !important;
}

/* إنزال القائمة الجانبية لتكون أسفل شريط Streamlit الأصلي */
...
@media (min-width: 769px) {
    ...
    .main .block-container {
        ...
        max-width: 1200px;
        margin-top: 180px !important; /* زيادة الهامش ليتناسب مع الرأسية والشريط الأصلي */
        padding-top: 1rem !important;
        padding-bottom: 1rem;
    }
    .stApp { margin-top:0 !important; padding-top:0 !important; }

    /* Header ثابت في سطح المكتب أسفل شريط Streamlit */
    #gp-fixed-header {
        position: fixed; top: 3.5rem; left: 0; right: 0; width: 100%;
        background: linear-gradient(135deg, #1e3a8a 0%, #2c5282 100%);
        padding: 1.5rem 2rem 1.5rem 350px;
        z-index: 9998; box-shadow: 0 4px 20px rgba(30,58,138,0.3);
...
@media (max-width: 768px) {
    ...
    .main .block-container {
        ...
        margin-top: 120px !important; /* زيادة الهامش ليتناسب مع الرأسية والشريط الأصلي */
    ...
    /* Header ثابت مضغوط للهاتف أسفل شريط Streamlit */
    #gp-fixed-header {
        position: fixed; top: 3.5rem; left: 0; right: 0; width: 100%;
        background: linear-gradient(135deg, #1e3a8a 0%, #2c5282 100%);
        padding: 0.6rem 0.8rem;
        z-index: 9998; box-shadow: 0 2px 10px rgba(30,58,138,0.4);
        display: flex; justify-content: space-between; align-items: center;
    }
    ...
    /* Sidebar على الهاتف: يظهر فوق كل شيء عند الفتح ولكنه أسفل الرأسية الأصلية */
